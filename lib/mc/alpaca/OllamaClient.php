...
class OllamaClient implements LLMClient
{
     ...
     */
    private static function getHttpClient(string $uri, string &$buffer, array $options = []): \mc\http
    {
    ...
    private static function tryAuthenticate(\mc\http $http, string $apiKey = ""): void {
